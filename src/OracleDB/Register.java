...
public class Register extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
                String name,userid,email,pass,cpass;
...
//step4 execute query   
String sql = "Insert into login values('"+name+"','" +userid+"','"+email+"','"+pass+"','"+cpass+"')";
stmt.executeUpdate(sql);
//System.out.println(rs.getString(1)+"  "+rs.getString(2)+"  "+rs.getString(3)+" "+rs.getString(4));  
  
  
             JOptionPane.showMessageDialog(this,"Register successfull");       //showMessageDialog(this,"User Created successfully");
